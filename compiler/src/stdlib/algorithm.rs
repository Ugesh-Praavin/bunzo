...
pub fn build() -> RuntimeValue {
    ...
    map.insert(
        ...
        make_builtin("algorithm.stable_sort", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "algorithm.stable_sort".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        ...
        make_builtin("algorithm.find", |args, l, c| {
            ...
            let pos = arr
                .borrow()
                .iter()
                .position(|x| format!("{x}") == format!("{target}"));
            Ok(pos
    ...
    map.insert(
        ...
        make_builtin("algorithm.binary_search", |args, l, c| {
            if args.len() != 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "algorithm.binary_search".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
            ...
            let found = arr
                .borrow()
                .binary_search_by(|x| format!("{x}").cmp(&format!("{target}")))
                .is_ok();
    ...
    map.insert(
        ...
        make_builtin("algorithm.lower_bound", |args, l, c| {
            if args.len() != 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "algorithm.lower_bound".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
            ...
            let pos = arr
                .borrow()
                .partition_point(|x| format!("{x}") < format!("{target}"));
    ...
    map.insert(
        ...
        make_builtin("algorithm.upper_bound", |args, l, c| {
            if args.len() != 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "algorithm.upper_bound".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        ...
        make_builtin("algorithm.min", |args, l, c| {
            ...
            let min_val = arr
                .borrow()
                .iter()
                .min_by(|x, y| format!("{x}").cmp(&format!("{y}")))
                .cloned()
    ...
    map.insert(
        ...
        make_builtin("algorithm.max", |args, l, c| {
            ...
            let max_val = arr
                .borrow()
                .iter()
                .max_by(|x, y| format!("{x}").cmp(&format!("{y}")))
                .cloned()
                .unwrap_or(RuntimeValue::Null);
            Ok(max_val)
        }),
    ...
    map.insert(
        ...
        make_builtin("algorithm.min_element", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "algorithm.min_element".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
            ...
            let pos = arr.borrow().iter().position(|x| {
                format!("{x}")
                    == format!(
                        "{}",
                        arr.borrow()
    ...
    map.insert(
        ...
        make_builtin("algorithm.max_element", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "algorithm.max_element".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        ...
        make_builtin("algorithm.rotate", |args, l, c| {
            ...
            Err(CompilerError::TypeMismatch {
                operation: "algorithm.rotate".into(),
    ...
    map.insert(
        ...
        make_builtin("algorithm.count", |args, l, c| {
            ...
            let count = arr
                .borrow()
                .iter()
                .filter(|x| format!("{x}") == format!("{target}"))
                .count();
