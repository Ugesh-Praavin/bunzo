...
pub fn build() -> RuntimeValue {
    ...
    let fns: &[(
        ...
        (
            "abs",
            |args, l, c| one_float(args, "abs", l, c).map(|f| RuntimeValue::Float(f.abs())),
        ),
        (
            "floor",
            |args, l, c| {
        ...
        (
            "ceil",
            |args, l, c| one_float(args, "ceil", l, c).map(|f| RuntimeValue::Float(f.ceil())),
        ),
        (
            "round",
            |args, l, c| {
        ...
        (
            "sin",
            |args, l, c| one_float(args, "sin", l, c).map(|f| RuntimeValue::Float(f.sin())),
        ),
        (
            "cos",
            |args, l, c| one_float(args, "cos", l, c).map(|f| RuntimeValue::Float(f.cos())),
        ),
        (
            "pow",
            |args, l, c| {
