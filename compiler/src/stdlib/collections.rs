...
pub fn build_vector() -> RuntimeValue {
    ...
    map.insert(
        "push".to_string(),
        make_builtin("vector.push", |args, l, c| {
            if args.len() != 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.push".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "pop".to_string(),
        make_builtin("vector.pop", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.pop".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "get".to_string(),
        make_builtin("vector.get", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.get".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "set".to_string(),
        make_builtin("vector.set", |args, l, c| {
            if args.len() < 3 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "insert".to_string(),
        make_builtin("vector.insert", |args, l, c| {
            if args.len() < 3 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "remove".to_string(),
        make_builtin("vector.remove", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.remove".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "front".to_string(),
        make_builtin("vector.front", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.front".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "back".to_string(),
        make_builtin("vector.back", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.back".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "len".to_string(),
        make_builtin("vector.len", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.len".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "capacity".to_string(),
        make_builtin("vector.capacity", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.capacity".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("vector.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("vector.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.clear".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("vector.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.contains".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
            ...
            let contains = arr
                .borrow()
                .iter()
                .any(|x| format!("{x}") == format!("{val}"));
            Ok(RuntimeValue::Boolean(contains))
        }),
    );
    map.insert(
        "index_of".to_string(),
        make_builtin("vector.index_of", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.index_of".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
            ...
            let pos = arr
                .borrow()
                .iter()
                .position(|x| format!("{x}") == format!("{val}"));
            Ok(pos
                .map(|idx| RuntimeValue::Integer(idx as i64))
                .unwrap_or(RuntimeValue::Integer(-1)))
        }),
    );
    map.insert(
        "reverse".to_string(),
        make_builtin("vector.reverse", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.reverse".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "sort".to_string(),
        make_builtin("vector.sort", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.sort".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "resize".to_string(),
        make_builtin("vector.resize", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.resize".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "swap".to_string(),
        make_builtin("vector.swap", |args, l, c| {
            if args.len() < 3 {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.swap".into(),
                    expected: 3,
                    found: args.len(),
                    line: l,
                    column: c,
            ...
            Err(CompilerError::TypeMismatch {
                operation: "vector.swap".into(),
                expected: "Integer and Integer".into(),
                found: format!("{}, {}", args[1].type_name(), args[2].type_name()),
                line: l,
                column: c,
            })
        }),
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("vector.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "vector.iter".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
...
pub fn build_deque() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("deque.new", |_args, _l, _c| {
            Ok(RuntimeValue::Array(Rc::new(RefCell::new(Vec::new()))))
        }),
    );
    map.insert(
        "push_front".to_string(),
        make_builtin("deque.push_front", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.push_front".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "push_back".to_string(),
        make_builtin("deque.push_back", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.push_back".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "pop_front".to_string(),
        make_builtin("deque.pop_front", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.pop_front".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "pop_back".to_string(),
        make_builtin("deque.pop_back", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.pop_back".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "front".to_string(),
        make_builtin("deque.front", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.front".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "back".to_string(),
        make_builtin("deque.back", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.back".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "get".to_string(),
        make_builtin("deque.get", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.get".into(),
                    expected: 2,
    ...
    map.insert(
        "set".to_string(),
        make_builtin("deque.set", |args, l, c| {
            if args.len() < 3 {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.set".into(),
                    expected: 3,
    ...
    map.insert(
        "len".to_string(),
        make_builtin("deque.len", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.len".into(),
                    expected: 1,
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("deque.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("deque.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.clear".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("deque.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.contains".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("deque.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "deque.iter".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
...
pub fn build_stack() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("stack.new", |_args, _l, _c| {
            Ok(RuntimeValue::Array(Rc::new(RefCell::new(Vec::new()))))
        }),
    );
    map.insert(
        "push".to_string(),
        make_builtin("stack.push", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.push".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "pop".to_string(),
        make_builtin("stack.pop", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.pop".into(),
                    expected: 1,
    ...
    map.insert(
        "top".to_string(),
        make_builtin("stack.top", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.top".into(),
                    expected: 1,
    ...
    map.insert(
        "len".to_string(),
        make_builtin("stack.len", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.len".into(),
                    expected: 1,
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("stack.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("stack.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.clear".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("stack.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.contains".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("stack.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "stack.iter".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
...
pub fn build_queue() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("queue.new", |_args, _l, _c| {
            Ok(RuntimeValue::Array(Rc::new(RefCell::new(Vec::new()))))
        }),
    );
    map.insert(
        "push".to_string(),
        make_builtin("queue.push", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.push".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "pop".to_string(),
        make_builtin("queue.pop", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.pop".into(),
                    expected: 1,
    ...
    map.insert(
        "front".to_string(),
        make_builtin("queue.front", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.front".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "back".to_string(),
        make_builtin("queue.back", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.back".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "len".to_string(),
        make_builtin("queue.len", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.len".into(),
                    expected: 1,
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("queue.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("queue.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.clear".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("queue.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.contains".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("queue.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "queue.iter".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
...
pub fn build_priority_queue() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("priority_queue.new", |_args, _l, _c| {
            Ok(RuntimeValue::Array(Rc::new(RefCell::new(Vec::new()))))
        }),
    );
    map.insert(
        "push".to_string(),
        make_builtin("priority_queue.push", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.push".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "pop".to_string(),
        make_builtin("priority_queue.pop", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.pop".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "top".to_string(),
        make_builtin("priority_queue.top", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.top".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "len".to_string(),
        make_builtin("priority_queue.len", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.len".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("priority_queue.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("priority_queue.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.clear".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("priority_queue.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.contains".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("priority_queue.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "priority_queue.iter".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
...
pub fn build_set() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("set.new", |_args, _l, _c| {
            Ok(RuntimeValue::Map(Rc::new(RefCell::new(HashMap::new()))))
        }),
    );
    map.insert(
        "insert".to_string(),
        make_builtin("set.insert", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "remove".to_string(),
        make_builtin("set.remove", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("set.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("set.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "set.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("set.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "set.clear".into(),
                    expected: 1,
    ...
    map.insert(
        "first".to_string(),
        make_builtin("set.first", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "set.first".into(),
                    expected: 1,
    ...
    map.insert(
        "last".to_string(),
        make_builtin("set.last", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "set.last".into(),
                    expected: 1,
    ...
    map.insert(
        ...
        make_builtin("set.lower_bound", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "set.lower_bound".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        ...
        make_builtin("set.upper_bound", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "set.upper_bound".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "union".to_string(),
        make_builtin("set.union", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "set.union".into(),
                    expected: 2,
    ...
    map.insert(
        ...
        make_builtin("set.intersection", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        ...
        make_builtin("set.difference", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        ...
        make_builtin("set.symmetric_difference", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "set.symmetric_difference".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("set.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "set.iter".into(),
                    expected: 1,
            ...
            let mut keys_vec: Vec<RuntimeValue> = m
                .borrow()
                .keys()
                .cloned()
...
pub fn build_map() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("map.new", |_args, _l, _c| {
            Ok(RuntimeValue::Map(Rc::new(RefCell::new(HashMap::new()))))
        }),
    );
    map.insert(
        "insert".to_string(),
        make_builtin("map.insert", |args, l, c| {
            if args.len() < 3 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "remove".to_string(),
        make_builtin("map.remove", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "contains".to_string(),
        make_builtin("map.contains", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
    ...
    map.insert(
        "is_empty".to_string(),
        make_builtin("map.is_empty", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.is_empty".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("map.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.clear".into(),
                    expected: 1,
    ...
    map.insert(
        "keys".to_string(),
        make_builtin("map.keys", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.keys".into(),
                    expected: 1,
    ...
    map.insert(
        "values".to_string(),
        make_builtin("map.values", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
            ...
            let mut pairs: Vec<(String, RuntimeValue)> = m
                .borrow()
                .iter()
    ...
    map.insert(
        "first_key".to_string(),
        make_builtin("map.first_key", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.first_key".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "last_key".to_string(),
        make_builtin("map.last_key", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.last_key".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        ...
        make_builtin("map.first_value", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.first_value".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        ...
        make_builtin("map.last_value", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.last_value".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "lower_bound".to_string(),
        make_builtin("map.lower_bound", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "map.lower_bound".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "upper_bound".to_string(),
        make_builtin("map.upper_bound", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "map.upper_bound".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("map.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "map.iter".into(),
                    expected: 1,
...
pub fn build_bitset() -> RuntimeValue {
    ...
    map.insert(
        "new".to_string(),
        make_builtin("bitset.new", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.new".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "set".to_string(),
        make_builtin("bitset.set", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.set".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "reset".to_string(),
        make_builtin("bitset.reset", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.reset".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "flip".to_string(),
        make_builtin("bitset.flip", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.flip".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "test".to_string(),
        make_builtin("bitset.test", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.test".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "count".to_string(),
        make_builtin("bitset.count", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.count".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
            ...
            let count = arr
                .borrow()
                .iter()
                .filter(|x| matches!(x, RuntimeValue::Boolean(true)))
                .count();
    ...
    map.insert(
        "any".to_string(),
        make_builtin("bitset.any", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.any".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
            ...
            let any = arr
                .borrow()
                .iter()
                .any(|x| matches!(x, RuntimeValue::Boolean(true)));
            Ok(RuntimeValue::Boolean(any))
        }),
    );
    map.insert(
        "none".to_string(),
        make_builtin("bitset.none", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.none".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
            ...
            let none = arr
                .borrow()
                .iter()
                .all(|x| matches!(x, RuntimeValue::Boolean(false)));
            Ok(RuntimeValue::Boolean(none))
        }),
    );
    map.insert(
        "all".to_string(),
        make_builtin("bitset.all", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.all".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
            ...
            let all = arr
                .borrow()
                .iter()
                .all(|x| matches!(x, RuntimeValue::Boolean(true)));
            Ok(RuntimeValue::Boolean(all))
        }),
    );
    map.insert(
        "len".to_string(),
        make_builtin("bitset.len", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.len".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "clear".to_string(),
        make_builtin("bitset.clear", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.clear".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "and".to_string(),
        make_builtin("bitset.and", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.and".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "or".to_string(),
        make_builtin("bitset.or", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.or".into(),
                    expected: 2,
    ...
    map.insert(
        "xor".to_string(),
        make_builtin("bitset.xor", |args, l, c| {
            if args.len() < 2 {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.xor".into(),
                    expected: 2,
                    found: args.len(),
                    line: l,
                    column: c,
    ...
    map.insert(
        "not".to_string(),
        make_builtin("bitset.not", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.not".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
    ...
    map.insert(
        "iter".to_string(),
        make_builtin("bitset.iter", |args, l, c| {
            if args.is_empty() {
                return Err(CompilerError::ArityMismatch {
                    name: "bitset.iter".into(),
                    expected: 1,
                    found: 0,
                    line: l,
                    column: c,
