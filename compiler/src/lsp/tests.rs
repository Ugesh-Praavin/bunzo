use crate::lsp::handlers::{compile_and_get_diagnostics, handle_hover, handle_definition};
...
";
    ...
    assert!(diags.is_empty(), "Expected no diagnostics for valid code, found: {:?}", diags);
}
