...
function activate(context) {
    ...
    const compilerPath = config.get('compilerPath') || 'bzc';
    const useCompilerLsp = config.get('useCompilerLsp') || false;
    let serverOptions;
    if (useCompilerLsp) {
        serverOptions = {
    ...
    client = new node_1.LanguageClient('bunzoLanguageServer', 'Bunzo Language Server', serverOptions, clientOptions);
